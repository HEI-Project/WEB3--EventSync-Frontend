                ...
                <div className="rounded-lg border border-slate-700 bg-slate-900/50 p-3 min-h-[2.75rem]">
                  {formData.speakerIds.length > 0 ? (
                    ...
                    <p className="text-xs text-slate-500 mb-2">
                      {loadingData ? 'Chargement...' : 'Aucun intervenant sélectionné'}
                    </p>
                  )}
                  <button
                    type="button"
                    ...
                    disabled={loadingData}
                    className="inline-flex items-center gap-1.5 rounded-md border border-dashed border-slate-600 px-3 py-1.5 text-xs font-medium text-slate-400 hover:border-violet-500/40 hover:text-violet-400 hover:bg-violet-500/5 transition-all disabled:opacity-50"
                  >
